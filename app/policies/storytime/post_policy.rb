module Storytime
  class PostPolicy
    ...
    def permitted_attributes
      attrs = [:title, :draft_content, :draft_version_id, :excerpt, :featured_media_id, :secondary_media_id, :slug, :published_at_date, :send_subscriber_email, :published_at_time, :language_id, :post_category_id, {:tag_list => []}]
